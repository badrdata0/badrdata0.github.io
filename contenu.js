...
const CATEGORIES = [
  { id: "finance", titre: "Finance",
    description: "Argent, investissement et intérêts composés, expliqués sans jargon.",
    image: "images/finance.svg" },
  { id: "machine-learning", titre: "Machine learning",
    description: "Comment les machines apprennent, avec des exemples concrets.",
    image: "images/machine-learning.svg" },
  { id: "psychologie", titre: "Psychologie",
    description: "Pourquoi on pense et on agit comme on le fait.",
    image: "images/psychologie.svg" }
];
...
const ESSAIS = [
  ...
  { titre: "Qu'est-ce qu'un réseau de neurones ?",
    date: "2026-09-12", categorie: "machine-learning",
